...
# 1 "expressions/test.fs"

open Ast

# 9 "expressions/test.fs"
...
# 254 "expressions/test.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 28 "expressions/test.fs"
                                            Assign(_1,_3) 
                   )
# 28 "expressions/test.fs"
                 : 'Stmt));
# 266 "expressions/test.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
...
# 289 "expressions/test.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 31 "expressions/test.fs"
                                               IfThen(_2,_4) 
                   )
# 31 "expressions/test.fs"
                 : 'Stmt));
# 301 "expressions/test.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            let _2 = (let data = parseState.GetInput(2) in (Microsoft.FSharp.Core.Operators.unbox data : 'Expr)) in
            let _4 = (let data = parseState.GetInput(4) in (Microsoft.FSharp.Core.Operators.unbox data : 'Stmt)) in
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 32 "expressions/test.fs"
                                                         IfThenElse(_2,_4,_6) 
                   )
# 32 "expressions/test.fs"
                 : 'Stmt));
# 314 "expressions/test.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            let _2 = (let data = parseState.GetInput(2) in (Microsoft.FSharp.Core.Operators.unbox data : 'Expr)) in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 33 "expressions/test.fs"
                                        Print(_2) 
                   )
# 33 "expressions/test.fs"
                 : 'Stmt));
# 325 "expressions/test.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            let _1 = (let data = parseState.GetInput(1) in (Microsoft.FSharp.Core.Operators.unbox data : 'Stmt)) in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 36 "expressions/test.fs"
                                      [_1] 
                   )
# 36 "expressions/test.fs"
                 : 'StmtList));
# 336 "expressions/test.fs"
        (fun (parseState : Microsoft.FSharp.Text.Parsing.IParseState) ->
            let _1 = (let data = parseState.GetInput(1) in (Microsoft.FSharp.Core.Operators.unbox data : 'StmtList)) in
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 37 "expressions/test.fs"
                                                   _3 :: _1  
                   )
# 37 "expressions/test.fs"
                 : 'StmtList));
|]
# 349 "expressions/test.fs"
